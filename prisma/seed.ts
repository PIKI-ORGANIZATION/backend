...
// Helper home hero section dan countdown di PNPS
const getHomeHeroDefault = (isPusat: boolean) => {
  if (!isPusat) return {};

  return {
    urlBannerImg:
      "https://www.hariansib.com/cdn/uploads/images/2026/01/3057_William-Sabandar-Pimpin-PNPS-GMKI-2025-2028--Usung-Misi-3K-2D-dan-2P.png",
    titleHomeHero:
      "Pengurus Nasional Perkumpulan Senior (PNPS) Gerakan Mahasiswa Kristen Indonesia (GMKI)",
    headlineHomeHero:
...
const getCountdownDefault = (isPusat: boolean) => {
  ...
  return {
    ...
    keteranganCountdown: "Menuju agenda nasional PNPS",
  };
};
...
const CABANG_LIST = [
  {
    ...
    sejarah: [
      { timeline: "2025", deskripsiTimeline: "PNPS GMKI resmi dibentuk sebagai wadah koordinasi nasional senior GMKI." },
      { timeline: "2026", deskripsiTimeline: "Pelantikan Pengurus Nasional PNPS GMKI Periode 2025-2028." },
    ],
  },
  {
    nama: "Jakarta",
...
async function seedAllCabang() {
  ...
  for (const c of CABANG_LIST) {
    ...
    const cabang = await prisma.cabang.upsert({
      ...
      noWa: "08123456789",
      instagram: `@pnps.${c.kotaEmail}`,
      facebook: `PNPS ${c.nama}`,
      youtube: `PNPS ${c.nama}`,
      email: c.email,
...
async function assignRolesToAkun() {
  ...
  for (const c of CABANG_LIST) {
    ...
    const adminCabang = await prisma.akun.findUnique({ where: { email: `admin_${c.kotaEmail}@pnps.id` } });
    if (adminCabang) await upsertAkunRole(adminCabang.uuid, adminCabangRole.uuid, insertBy);
    const ketuaCabang = await prisma.akun.findUnique({ where: { email: `ketua_${c.kotaEmail}@pnps.id` } });
...
async function seedNews() {
  ...
  const tagNames = ["PNPS","GMKI","Pelantikan","Nasional","Seminar","Kongres","Rapat Kerja","Leadership"];
  ...
  const newsList = [
    {
      ...
      slug: "william-sabandar-pimpin-pnps",
      ringkasan:
      ...
      konten:
        ...
        <p><br></p>
        <p>Komitmen ini ditegaskan Ketua Umum Pengurus Nasional Perkumpulan Senior (PNPS) GMKI</p>
        <p>masa bakti 2025-2028, William Sabandar, dalam pidatonya, pada acara Peneguhan dan</p>
        <p>Serah Terima PNPS GMKI, Minggu (11/01/2026) malam. Kegiatan yang dirangkaikan dengan</p>
        <p>Perayaan Natal 2025 dan Tahun Baru 2026, berlangsung di Ballroom Grha Oikumene PGI,</p>
        <p>Jakarta.</p>
        <p>Pada kesempatan tersebut, William yang menggantikan posisi Ketua Umum PNPS yang</p>
        <p>periode sebelumnya Febry Calvin Tetelepta (2022-2025), memaparkan arah baru organisasi</p>
        <p>dengan fokus utama pada persatuan dan pelayanan. Karena itulah, pada periode ini PNPS</p>
        ...
        <p>Selain itu, GMKI dan PNPS juga harus memberi perhatian khusus kepada wilayah seperti</p>
        ...
        <p><br></p>
        <p>Misi PNPS</p>
        <p>Untuk mewujudkan visi tersebut, PNPS GMKI akan menjalankan misi &quot;3K&quot; (Komunikasi,</p>
        <p>Kolaborasi, dan Kebersamaan). Karena itulah PNPS haruslah menjadi &quot;Rumah Besar&quot; yang</p>
        ...
        <p>depan PNPS harus menjadi mitra strategis bagi adik-adik mahasiswa GMKI yang masih aktif.</p>
        ...
        <p>Selain 3K, PNPS juga memiliki misi 2D, dan 2P kemandirian Daya dan Dana (2D), serta PNPS</p>
        ...
        <p>Ketua Umum PNPS periode sebelumnya, Febry Calvin Tetelepta, menyebut komposisi</p>
        ...
        <p>membawa PNPS tetap berjalan tanpa didikte siapapun,&rdquo; pesannya.</p>
        <p>Febry berharap PNPS bisa fokus berjuang di tengah kondisi bangsa yang tidak baik-baik saja</p>
        ...
        <p>Sekretaris Umum Pengurus Pusat GMKI Jessica Warouw menyebut hubungan PNPS dan</p>
        <p>GMKI bak &rsquo;kakak adik&rsquo;. &rdquo;Senior merupakan abang dan kakak tempat kami belajar tentang</p>
        <p>keberanian dan kesetiaan dalam berorganisasi. Kami memandang PNPS sebagai mitra</p>
        <p>strategis dalam membangun GMKI melalui berbagai program kolaborasi nyata,&rdquo; kata Jessica</p>
        <p>Warouw.</p>
        <p>Ibadah Peneguhan PNPS GMKI 2025-2028 dipimpin Ketua Umum PGI Pdt Jacklevyn Frits</p>
        ...
        <p>STRUKTUR ORGANISASI PNPS GMKI 2025-2028</p>
        ...
        <p>Narahubung :</p>
        <p>Sekjend PNPS-Jeirry Sumampow (08129948695)</p>
        ...
        author: admin,
        status: "PUBLISHED",
        tags: ["PNPS", "GMKI", "Pelantikan"],
        kategori: ["Siaran Pers", "Nasional"],
      },

      {
        judul: "Berikut Nama 45 Pengurus PNPS GMKI Masa Bakti 2025 - 2028",
        slug: "berikut-nama-45-pengurus-pnps-gmki-masa-bakti-2025-2028",
        ringkasan:
          "Berikut Nama 45 Pengurus PNPS GMKI Masa Bakti 2025 - 2028",
        konten:
          `
        ...
        <p>Ketua Umum PNPS periode sebelumnya, Febry Calvin Tetelepta, menyebut komposisi kepengurusan kali ini sebagai ’the dream team’.</p>

        <p>”Tetap jaga eksistensi netralitas dari semua kepentingan politik, meski kita harus akui dengan pilihan netral itu membawa konsekuensi ruang kita jadi agak sempit. Di sinilah butuh keluwesan dan kecerdasan pemimpin organisasi membawa PNPS tetap berjalan tanpa didikte siapapun,” pesannya.</p>
        ...
        <p>Febry berharap PNPS bisa fokus berjuang di tengah kondisi bangsa yang tidak baik-baik saja akibat kebijakan pemotongan anggaran, dan berdampak pada daerah-daerah kantong Kristen terutama di kawasan timur Indonesia. Sekretaris Umum Pengurus Pusat GMKI Jessica Warouw menyebut hubungan PNPS dan GMKI bak ’kakak adik’.</p>
        <p>”Senior merupakan abang dan kakak tempat kami belajar tentang keberanian dan kesetiaan dalam berorganisasi. Kami memandang PNPS sebagai mitra strategis dalam membangun GMKI melalui berbagai program kolaborasi nyata,” kata Jessica Warouw.</p>

        <h3 class="font-bold text-xl mt-8 mb-4">STRUKTUR ORGANISASI PNPS GMKI 2025 – 2028</h3>
...

    {
      ...
      konten:
        ...
        William Sabandar resmi menjabat sebagai Ketua Umum Pengurus Nasional Perkumpulan Senior (PNPS) Gerakan Mahasiswa Kristen Indonesia (GMKI) masa bakti 2025-2028.Dalam prosesi peneguhan dan serah terima jabatan yang berlangsung di Ballroom Grha Oikumene PGI, Jakarta, Minggu (11/1/2026) malam, William menegaskan komitmen organisasi untuk mengawal keadilan sosial, khususnya di wilayah Papua dan Indonesia Timur.
        Mantan Direktur Utama PT MRT Jakarta ini menggantikan Febry Calvin Tetelepta yang menjabat pada periode 2022-2025. Di bawah kepemimpinannya, PNPS GMKI mengusung visi "Bersatu Melayani lewat Peran Senior GMKI untuk Mewujudkan Damai Sejahtera di Bumi Indonesia".Dalam pidato perdana, William menyoroti paradoks pembangunan di wilayah timur Indonesia. Ia memaparkan data bahwa meski Papua dan Maluku mencakup 40 persen luas wilayah Indonesia, kontribusi PDB-nya hanya sebesar dua persen terhadap total nasional.
        Baca Juga:
        PNPS GMKI 2022-2025 Dilantik, Diharapkan Aktif Jawab Persoalan Bangsa
    ...
    {
      judul: "PNPS GMKI Tegaskan Aksi Nyata Menuju Indonesia Emas 2045",
      slug: "pnps-gmki-tegaskan-aksi-nyata-menuju-indonesia-emas-2045",
      ringkasan:
        "PNPS GMKI menegaskan komitmennya untuk berkontribusi dalam mewujudkan Indonesia Emas 2045...",
      konten:
        `
            MEDIA PERISAI.COM, JAKARTA, 12 Januari 2026 — Perkumpulan Senior Gerakan Mahasiswa Kristen Indonesia (PNPS GMKI) menegaskan komitmennya untuk memberikan kontribusi nyata bagi bangsa Indonesia dalam menyongsong Indonesia Emas 2045. Komitmen tersebut tidak hanya diwujudkan dalam wacana, tetapi melalui aksi konkret di tengah kehidupan jemaat, kampus, dan komunitas lokal di seluruh Indonesia, termasuk Papua dan daerah-daerah yang membutuhkan perhatian khusus.

        Komitmen itu disampaikan Ketua Umum PNPS GMKI periode 2025–2028, William Sabandar, dalam pidatonya pada acara Peneguhan dan Serah Terima Pengurus Nasional Perkumpulan Senior (PNPS) GMKI, Minggu (11/1/2026) malam. Kegiatan tersebut dirangkaikan dengan Perayaan Natal 2025 dan Tahun Baru 2026 yang berlangsung di Ballroom Grha Oikumene PGI, Jakarta.

        William Sabandar menggantikan Ketua Umum PNPS GMKI periode sebelumnya, Febry Calvin Tetelepta (2022–2025). Dalam kesempatan itu, William memaparkan arah baru organisasi yang menitikberatkan pada persatuan dan pelayanan. Oleh karena itu, PNPS GMKI mengusung visi “Bersatu Melayani lewat Peran Senior GMKI untuk Mewujudkan Damai Sejahtera di Bumi Indonesia.”
        ...
        Karena itu, GMKI dan PNPS GMKI diharapkan berperan aktif membentuk generasi pemimpin yang memahami bahwa pertumbuhan harus adil dan inklusif. Selain itu, perhatian khusus perlu diberikan kepada wilayah seperti Papua melalui pembangunan yang menghormati martabat orang asli Papua, menjaga kelestarian ciptaan, dan menumbuhkan damai sejahtera, bukan sekadar mengejar angka pertumbuhan.


        Misi PNPS GMKI
        Untuk mewujudkan visi tersebut, PNPS GMKI menetapkan misi 3K, 2D, dan 2P. 3K yakni Komunikasi, Kolaborasi, dan Kebersamaan. PNPS diharapkan menjadi “rumah besar” yang nyaman bagi seluruh senior GMKI lintas generasi untuk berkumpul, bersekutu, dan memperkuat kembali hubungan emosional serta spiritual dengan GMKI.

        Selain itu, PNPS GMKI juga diarahkan menjadi mitra strategis bagi GMKI aktif. “Komunikasi antara senior dan GMKI aktif harus mengalir dengan baik, bukan hanya saat ada masalah, tetapi dalam ritme pelayanan sehari-hari,” ujar Willy.

        PNPS GMKI juga mengusung misi 2D (kemandirian daya dan dana) serta 2P sebagai platform penggerak. Sebanyak 45 pengurus yang dilantik diharapkan mampu menempatkan Perkumpulan Senior GMKI sebagai bagian dari perjalanan bangsa sejak Proklamasi 1945 hingga menuju Indonesia Emas 2045.

        Ketua Umum PNPS GMKI periode 2022–2025, Febry Calvin Tetelepta, menyebut komposisi kepengurusan kali ini sebagai “the dream team.” Ia berpesan agar PNPS GMKI tetap menjaga netralitas dari berbagai kepentingan politik.

        “Netralitas memang membuat ruang gerak kita menjadi lebih sempit. Di sinilah dibutuhkan keluwesan dan kecerdasan kepemimpinan agar PNPS tetap berjalan tanpa didikte siapa pun,” katanya.

        Sementara itu, Sekretaris Umum Pengurus Pusat GMKI, Jessica Warouw, menggambarkan hubungan PNPS dan GMKI seperti kakak dan adik. “Senior adalah abang dan kakak tempat kami belajar keberanian dan kesetiaan dalam berorganisasi. PNPS kami pandang sebagai mitra strategis dalam membangun GMKI melalui program kolaborasi nyata,” ujarnya.

        Ibadah Peneguhan PNPS GMKI 2025–2028 dipimpin Ketua Umum PGI Pdt. Jacklevyn Frits Manuputty dan dihadiri sejumlah tokoh lintas gereja, akademisi, serta perwakilan organisasi kepemudaan dan legislatif, yaitu: Sekretaris Umum PGI Pdt Darwin Darmawan, Rektor Universitas Kristen Satya Wacana Salatiga Prof Intiyas Utami, Sekum LAI Sigit Triyono, Sekjen PIKI Audy Wuisang, hakim konsitusi Daniel Yusmic Foekh, senior-senior GMKI lain, serta anggota DPR yang juga Wasekjen PB Ikatan Alumni PMII Zainul Munasichin. (AS)
            `,
...
Dengan formasi yang solid dan representatif ini, PCPS GMKI Ambon diharapkan mampu menjadi mitra strategis dalam mendukung penguatan kaderisasi GMKI, memperluas jejaring kolaborasi, serta menghadirkan kontribusi nyata bagi pembangunan Maluku dalam empat tahun ke depan.</span></span></span></div></div>`,
      thumbnail: "http://data.seniorgmki.com/uploads/1772189374037-e7eb742813858e72760992c6.jpg",
      status: "PUBLISHED",
      tags: ["Siaran Pers", "Organisasi"],
      author: user,
      kategori: ["GMKI", "PNPS", "Pelantikan"],
    },
    {
...
<p></p>
<p>       Ketua Umum PNPS GMKI William Sabandar menegaskan, acara ini bukan sekadar nonton bareng, tetapi mengajak publik melakukan perjalanan bersama dalam perjuangan persoalan gender, budaya, dan terwujudnya masyarakat yang inklusif.</p>
<p>“Film ini masih akan terus relevan sepanjang pesan di dalamnya belum terlaksana. Mari lahirkan gerakan bersama, dimulai dari diri sendiri dan keluarga kita. Mulai dari langkah kecil, agar banyak ketimpangan yang kita lihat di film ini bisa terjembatani,” kata Ketua Umum PNPS GMKI William Sabandar.</p>
<p></p>
...
async function seedStrukturOrganisasi() {
  ...
  const cabangPusat = await prisma.cabang.findUnique({
    where: { email: "pusat@pnps.id" },
  });

  const cabangJakarta = await prisma.cabang.findUnique({
    where: { email: "jakarta@pnps.id" },
  });
  ...
  // PERIODE
  //////////////////////////////////////////////////
  const periodePNPS = await prisma.periodeKepengurusan.upsert({
  ...
  const periodePCPS = await prisma.periodeKepengurusan.upsert({
  ...
  console.log("✅ Struktur Organisasi seeded (FULL PNPS)");
}
...
async function seedSeniorPNPS() {
  ...
  console.log(`✅ ${seniorList.length} Senior PNPS seeded`);
}
...
async function seedGaleri() {
  ...
  const albumList = [
    {
      namaAlbum: "Pelantikan PNPS GMKI 2025-2028",
      deskripsi: "Dokumentasi foto acara peneguhan dan serah terima Pengurus Nasional PNPS GMKI Periode 2025-2028.",
      ...
      media: [
        ...
        { tipeMedia: "VIDEO", urlMedia: "https://www.youtube.com/embed/example1", thumbnail: "/galeri/video/pelantikan-thumb.webp", keterangan: "Pelantikan PNPS GMKI 2025-2028 - Full Video", durasi: "1:45:30", urutan: 6 },
        { tipeMedia: "VIDEO", urlMedia: "https://www.youtube.com/embed/example2", thumbnail: "/galeri/video/pidato-willy-thumb.webp", keterangan: "Pidato Perdana Ketua Umum PNPS William Sabandar", durasi: "25:10", urutan: 7 },
      ],
    },
    {
      namaAlbum: "Rapat Kerja Nasional PNPS 2026",
      deskripsi: "Dokumentasi foto Rapat Kerja Nasional PNPS GMKI.",
    ...
    {
      namaAlbum: "Kunjungan Papua - Advokasi PNPS 2026",
      deskripsi: "Dokumentasi kunjungan tim PNPS ke Papua dalam rangka program advokasi.",
    ...
    {
      namaAlbum: "Webinar PNPS 2026",
      deskripsi: "Rekaman webinar nasional PNPS GMKI.",
      tanggalKegiatan: new Date("2026-02-05"),
      coverMedia: "/galeri/video/webinar-thumb.webp",
      isPublic: true,
      media: [
        { tipeMedia: "VIDEO", urlMedia: "https://www.youtube.com/embed/example3", thumbnail: "/galeri/video/webinar-thumb.webp", keterangan: "Webinar Nasional PNPS", durasi: "2:10:45", urutan: 1 },
      ],
    },
  ];
  ...
  const programList = [
    {
      ...
      agenda: [
        {
          namaAgenda: "Rapat Koordinasi Nasional PNPS 2026",
        ...
        },
        {
          ...
          linkPendaftaran: "https://forms.pnps.id/webinar-april",
          arsip: [],
        },
      ],
    },
      ...
      agenda: [
        {
          ...
          linkPendaftaran: "https://forms.pnps.id/seminar-papua",
          arsip: [
            {
    ...
    {
      namaProgram: "Katalog Program Kerja PNPS 2026",
      deskripsi: "Katalog lengkap seluruh program kerja PNPS GMKI untuk tahun 2026.",
    ...
    },
    {
      ...
      tujuan: "Menjaga dan meningkatkan kualitas spiritual anggota PNPS.",
      sasaran: "Seluruh anggota PNPS",
      ...
      agenda: [
        {
          ...
          linkPendaftaran: "https://forms.pnps.id/retreat-2026",
          arsip: [],
        },
      ],
    },
...
async function seedKritikSaran() {
  ...
  const faqList = [
    {
      pertanyaan: "Apa itu PNPS GMKI?",
      jawaban: "PNPS (Perkumpulan Senior GMKI) adalah organisasi yang menghimpun para alumni dan senior GMKI (Gerakan Mahasiswa Kristen Indonesia) sebagai wadah untuk bersatu, berkolaborasi, dan memberikan kontribusi nyata bagi bangsa Indonesia.",
      kategori: "UMUM",
      urutan: 1,
      isPublish: true,
    },
    {
      pertanyaan: "Bagaimana cara mendaftar menjadi anggota PNPS?",
      jawaban: "Pendaftaran anggota PNPS dapat dilakukan melalui website resmi dengan mengisi formulir pendaftaran, kemudian akan diverifikasi oleh pengurus cabang (PCPS) setempat dan mendapat persetujuan dari PNPS Pusat.",
      kategori: "KEANGGOTAAN",
      urutan: 2,
      isPublish: true,
    },
    {
      pertanyaan: "Apa syarat menjadi anggota PNPS GMKI?",
      jawaban: "Syarat utama adalah pernah menjadi anggota/pengurus aktif GMKI di tingkat komisariat atau cabang mana pun di Indonesia. Calon anggota wajib mengisi data diri secara lengkap dan disetujui oleh PCPS dan PNPS.",
      kategori: "KEANGGOTAAN",
      urutan: 3,
      isPublish: true,
    },
    {
      ...
      jawaban: "The Grit Institut adalah lembaga pendidikan dan pengembangan kapasitas di bawah naungan PNPS GMKI yang menyediakan berbagai program edukasi, pelatihan kepemimpinan, kelas, dan workshop untuk pengembangan potensi anggota dan masyarakat.",
      kategori: "PROGRAM",
      urutan: 4,
      isPublish: true,
    },
    ...
    {
      pertanyaan: "Di mana saya bisa menemukan informasi struktur organisasi PNPS?",
      jawaban: "Struktur organisasi PNPS dan PCPS dapat ditemukan di menu Struktur Organisasi pada website ini. Tersedia informasi lengkap mengenai periode kepengurusan aktif beserta nama dan jabatan setiap pengurus.",
      kategori: "ORGANISASI",
      urutan: 6,
      isPublish: true,
    },
    ...
    {
      pertanyaan: "Apa saja program unggulan PNPS GMKI periode 2025-2028?",
    ...
    {
      pertanyaan: "Bagaimana cara menghubungi pengurus PNPS?",
      jawaban: "Anda dapat menghubungi PNPS melalui email pusat@pnps.id, WhatsApp di nomor 08123456789, atau melalui media sosial resmi kami di Instagram @pnps.gmki dan Facebook PNPS GMKI.",
      kategori: "UMUM",
      urutan: 10,
      isPublish: true,
    },
  ...
  const pengaduanList = [
    {
      ...
      isiBadan: "Saya ingin menanyakan lebih lanjut mengenai proses pendaftaran anggota PNPS. Apakah ada batas waktu pendaftaran dan dokumen apa saja yang dibutuhkan?",
      kategoriAduan: "KEANGGOTAAN",
      statusPengaduan: "SELESAI",
      tanggapan: "Terima kasih atas pertanyaan Anda. Pendaftaran anggota PNPS terbuka sepanjang tahun tanpa batas waktu. Dokumen yang diperlukan: foto profil, data angkatan GMKI, dan cabang asal. Silakan mengisi formulir di website kami.",
      tanggalTanggapan: new Date("2026-01-20"),
      isAnonymous: false,
    },
    {
      namaPelapor: "Anonim",
      emailPelapor: "anonim001@pnps.id",
      noWaPelapor: null,
      subjek: "Masukan untuk peningkatan website",
      isiBadan: "Website PNPS sudah bagus, namun sebaiknya ditambahkan fitur pencarian anggota berdasarkan kota/cabang agar lebih mudah terhubung dengan sesama senior.",
      kategoriAduan: "UMUM",
    ...
    },
    {
      ...
      isiBadan: "Saya senior GMKI dari Medan dan ingin mendapatkan informasi tentang kegiatan PNPS di wilayah Sumatera. Apakah ada rencana kegiatan di Medan tahun 2026?",
    ...
    {
      namaPelapor: "Anonim",
      emailPelapor: "anonim002@pnps.id",
      noWaPelapor: null,
