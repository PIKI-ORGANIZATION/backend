...
export const registerSchema = z.object({
  ...
  pendidikanUuid: z.string().uuid("Pendidikan UUID tidak valid").optional(),
  pekerjaanUuid: z.string().uuid("Pekerjaan UUID tidak valid").optional(),
  ...
  bidangStudiUuid: z.string().uuid("Bidang Studi UUID tidak valid").optional(),
  bidangMinatUuid: z.string().uuid("Bidang Minat UUID tidak valid").optional(),
