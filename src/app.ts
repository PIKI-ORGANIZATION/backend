...
import dpdRoutes from './routes/dpd.routes';
import dpdDpcRoutes from './routes/dpdDpc.routes';
...
app.use('/api/v1/anggotas', anggotaRoutes);
...
app.use('/api/v1/dpd', dpdRoutes);
app.use('/api/v1/dpd-dpc', dpdDpcRoutes);
